...
public class WarpingEmiRecipe implements EmiRecipe{
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addText(new LiteralText("toss").asOrderedText(), widgets.getWidth()/2-13, 2, 0xffffff, true);
        ...
        widgets.addDrawable(widgets.getWidth()/2-18, 2, 36, 44, (matrices, mouseX, mouseY, delta) -> {})
            .tooltip((mouseX, mouseY) -> List.of(TooltipComponent.of(new LiteralText(dimensionName.getString()).asOrderedText())));
    }
}
