...
public class APBlocks {
    ...
    public static final Block ILLUMINATED_OLIVESTONE    =  new Block(AbstractBlock.Settings.copy(OLIVESTONE_BRICK).luminance((state) -> 15));
    ...
    public static final Block ALGAL_LAMP = new Block(AbstractBlock.Settings.copy(Blocks.SEA_LANTERN));
    ...
    public static final Block PIPE = new PipeBlock(APBlockSettings.PLATING.nonOpaque());
        //Spools
    public static final Block SPOOL =  new PillarBlock(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL));

    // Scute Block
    public static final Block SCUTE_BLOCK = new Block(AbstractBlock.Settings.of(Material.STONE, MapColor.LIME).strength(5.0F, 6.0F).sounds(BlockSoundGroup.BASALT));
...
//    public static final List<StoneBlockSet> ORE_BRICKS = addOreBricks();
    ...
    // Gilded Sandstone
    public static final Block GILDED_SANDSTONE = new Block(AbstractBlock.Settings.copy(Blocks.SANDSTONE));
    public static final Block GILDED_SANDSTONE_PILLAR = new PillarBlock(AbstractBlock.Settings.copy(Blocks.SANDSTONE));
    public static final Block CHISELED_GILDED_SANDSTONE =  new Block(AbstractBlock.Settings.copy(Blocks.SANDSTONE));

    // Polished Glowstone
    public static final Block POLISHED_GLOWSTONE = new Block(AbstractBlock.Settings.copy(Blocks.GLOWSTONE));
    public static final Block RUNIC_GLOWSTONE =  new Block(AbstractBlock.Settings.copy(Blocks.GLOWSTONE));
    ...
    // Wither Lamp
    public static final Block WITHER_LAMP =  new Block(AbstractBlock.Settings.copy(Blocks.SEA_LANTERN));
    ...
    public static final Block TWISTING_BLACKSTONE = new Block(AbstractBlock.Settings.copy(Blocks.BLACKSTONE));
    public static final Block WEEPING_BLACKSTONE_BRICKS =  new Block(AbstractBlock.Settings.copy(Blocks.POLISHED_BLACKSTONE_BRICKS));
    public static final Block TWISTING_BLACKSTONE_BRICKS =  new Block(AbstractBlock.Settings.copy(Blocks.POLISHED_BLACKSTONE_BRICKS));
    ...
    public static final Block CHISELED_BASALT_TILES =  new Block(AbstractBlock.Settings.copy(Blocks.BASALT));

    // Heavy Stone Bricks
    public static final Block HEAVY_STONE_BRICKS = new BigBrickBlock(AbstractBlock.Settings.copy(Blocks.STONE_BRICKS));
    public static final Block HEAVY_MOSSY_STONE_BRICKS =  new BigBrickBlock(AbstractBlock.Settings.copy(Blocks.MOSSY_STONE_BRICKS));
    public static final Block HEAVY_CRACKED_STONE_BRICKS =  new BigBrickBlock(AbstractBlock.Settings.copy(Blocks.CRACKED_STONE_BRICKS));
    ...
    public static final Block ENTWINE_BARS = new APPaneBlock(AbstractBlock.Settings.copy(ENTWINE).nonOpaque());
    // Ender Pearl Block
    public static final Block ENDER_PEARL_BLOCK =  new Block(APBlockSettings.ENDER_PEARL);

    // End Stone Variants
    public static final Block   CHORAL_END_STONE_BRICKS = new Block(AbstractBlock.Settings.copy(Blocks.END_STONE_BRICKS));
    public static final Block  CRACKED_END_STONE_BRICKS = new Block(AbstractBlock.Settings.copy(Blocks.END_STONE_BRICKS));
    public static final Block CHISELED_END_STONE_BRICKS = new Block(AbstractBlock.Settings.copy(Blocks.END_STONE_BRICKS));

    // Heavy End Stone Bricks
    public static final Block HEAVY_END_STONE_BRICKS =  new BigBrickBlock(AbstractBlock.Settings.copy(Blocks.END_STONE_BRICKS), BigBrickBlock.BrickType.END_STONE);
    public static final Block HEAVY_CRACKED_END_STONE_BRICKS = new BigBrickBlock(AbstractBlock.Settings.copy(Blocks.END_STONE_BRICKS), BigBrickBlock.BrickType.END_STONE);

    // Warpstone
    public static final Block WARPSTONE = new Block(AbstractBlock.Settings.copy(Blocks.STONE));
    ...
    public static final Block        TWISTED_LEAVES =   new LeavesBlock(AbstractBlock.Settings.copy(Blocks.OAK_LEAVES));
    ...
    public static final Block        TWISTED_SAPLING =  new APSaplingBlock(new TwistedTree(), AbstractBlock.Settings.copy(Blocks.OAK_SAPLING));
